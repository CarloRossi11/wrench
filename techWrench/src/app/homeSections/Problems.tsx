  ...
  return (
    <section className={styles.problems}>
      ...
      <p>
        ...
        visibility, and failing to leverage your existing customers quietly cost
        businesses customers every day.
      </p>
          ...
          <AnimatePresence initial={false}>
            {openIndex === 1 && (
              <motion.p
                ...
                style={{ overflow: "hidden" }}
              >
                Over half of inbound business calls go unanswered after business
                hours or when you're out in the field. Without an instant
                response, those homeowners immediately move on to your closest
                competitor.
              </motion.p>
            )}
          </AnimatePresence>
          ...
          <AnimatePresence initial={false}>
            {openIndex === 2 && (
              <motion.p
                ...
                style={{ overflow: "hidden" }}
              >
                80% of leads choose the contractor who responds first. Letting
                website contact forms or Facebook messages sit untouched for
                even an hour slashes your booking rate to near zero.
              </motion.p>
            )}
          </AnimatePresence>
        </div>
          ...
          <AnimatePresence initial={false}>
            {openIndex === 3 && (
              <motion.p
                ...
                style={{ overflow: "hidden" }}
              >
                Your past customers are your most profitable asset. Leaving them
                stranded without consistent check-ins or automated referral
                requests leaves massive revenue trapped inside your old client
                lists.
              </motion.p>
            )}
          </AnimatePresence>
