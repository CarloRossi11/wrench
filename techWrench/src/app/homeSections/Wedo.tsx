  ...
  return (
    <section className={styles.weDo}>
      ...
      <p>
        ...
        businesses get found, build trust, and convert more visitors into leads.
        Fast, mobile-friendly, and search-engine optimized, they serve as the
        engine behind your online growth.
      </p>
          ...
          >
            <div className={styles.feature}>
              ...
              <div className={styles.featureContent}>
                ...
                <p className={styles.support}>
                  A beautiful site means nothing if it sits on page 5 of Google.
                  We bake local search engine optimization into the foundation
                  so you're positioned where high-intent buyers are looking.
                </p>
              </div>
            </div>
          </motion.div>
